    ...
    return (
        <div className='relative overflow-x-clip'>
            ...
            <div className="container px-3 mx-auto">
                ...
                <p className=' text-lightWhite leading-4 lg:leading-6 text-sm lg:text-base font-normal text-center pt-3 lg:pt-7'>In a matter of minutes, one of our AI mentors will contact you, No <span className="block">Experience Required!</span></p>
